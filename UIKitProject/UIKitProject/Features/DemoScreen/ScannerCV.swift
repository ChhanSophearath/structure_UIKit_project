...
class ScannerCV: BaseUIViewConroller  {
    ...
    private let heightScan: CGFloat = 300
...
extension ScannerCV:  AVCaptureMetadataOutputObjectsDelegate {
...
extension ScannerCV{
    ...
    private func startScanAnimate() {
        DispatchQueue.main.async { [self] in
            ...
            UIView.animate(withDuration: 0.8, // duration animation
                           delay: 0.2,
    ...
    private func createOverlay() -> UIView {
        ...
        NSLayoutConstraint.activate([
            ...
            stackButton.bottomAnchor.constraint(equalTo: overlayView.bottomAnchor, constant: -80),
...
//MARK: - Upload QRCode
extension ScannerCV: UIImagePickerControllerDelegate,UINavigationControllerDelegate{
...
extension ScannerCV: AVCapturePhotoCaptureDelegate {
